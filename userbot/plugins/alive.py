...
ALIVE_caption += "**Bot Made By @telugucartoonlover** \n\n"
ALIVE_caption += "Copyright By [DEEPANIK](GitHub.com/Akhilsivakosana1)\n\n"
ALIVE_caption += "[Deploy ArianaUserBot](GitHub.com/deepanik/TCLUserBot)"
