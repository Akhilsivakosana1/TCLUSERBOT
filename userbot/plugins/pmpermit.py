...
if not PMPERMIT_PIC:
    WARN_PIC = "https://telegra.ph/file/a8cf9812c35f9c04eac27.jpg"
else:
...
CUSTOM_MIDDLE_PMP = (
    str(CUSTOM_PMPERMIT) if CUSTOM_PMPERMIT else "Protection By TCL🇮🇳"
)
...
USER_BOT_NO_WARN = (
    "**Hello, This is TCL PM Protection Service ⚠️**\n\n"
